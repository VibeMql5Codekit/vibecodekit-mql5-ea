...
pytest tests/ -q            # → 150 passed, 2 skipped locally without Wine/MetaEditor
```
...
**Expected locally:** `150 passed, 2 skipped` when Wine/MetaEditor are unavailable; 17 presets.
...
- Test suite: pytest tests/ -q → 150 passed, 2 skipped locally without Wine/MetaEditor
```
