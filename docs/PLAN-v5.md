...
> ⚠️ **Internal / contributor document.** This is an internal sprint planning
> doc that records the kit's own development phases. End users do **not** need
> to read it — see [`README.md`](../README.md) and
